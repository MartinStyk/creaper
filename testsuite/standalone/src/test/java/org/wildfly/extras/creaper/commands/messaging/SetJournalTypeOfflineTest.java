 ...
 * @author mstyk
 */
public class SetJournalTypeOfflineTest {
    ...
    private static final String SUBSYTEM_ORIGINAL_ACTIVEMQ = ""
            ...
            + "    </profile>\n"
            + "</server>";
    private static final String SUBSYTEM_SET0_ACTIVEMQ = ""
            + "<server xmlns=\"urn:jboss:domain:1.7\">\n"
            + "    <profile>\n"
            + "         <subsystem xmlns=\"urn:jboss:domain:messaging-activemq:1.0\">\n"
            + "            <server name=\"default\">\n"
    ...
    private static final String SUBSYTEM_SET1_HORNETQ
            ...
            + "                    <in-vm-acceptor name=\"in-vm\" server-id=\"0\"/>\n"
            + "                </acceptors>\n"
            + "<journal-type>TYP1</journal-type>"
            + "            </hornetq-server>\n"
            + "        </subsystem>\n"
            + "    </profile>\n"
            + "</server>";
    private static final String SUBSYTEM_SET2_HORNETQ
            ...
            + "                    <in-vm-acceptor name=\"in-vm\" server-id=\"0\"/>\n"
            + "                </acceptors>\n"
            + "<journal-type>TYP2</journal-type>"
            + "            </hornetq-server>\n"
            + "        </subsystem>\n"
            + "    </profile>\n"
            + "</server>";
    ...
    @Test
    public void type0AMQ() throws Exception {
        ...
        client.apply(new SetJournalType("TYP0"));
        System.out.println(Files.toString(cfg, Charsets.UTF_8));
        assertXmlIdentical(SUBSYTEM_SET0_ACTIVEMQ, Files.toString(cfg, Charsets.UTF_8));
    }

    @Test
    public void type2AMQ() throws Exception {
        File cfg = tmp.newFile("xmlTransform.xml");
