 ...
 * @author mstyk
 */
public class SetLargeMessagesDirectoryOfflineTest {
    ...
    private static final String SUBSYTEM_ORIGINAL_ACTIVEMQ = ""
            ...
            + "                <bindings-directory path=\"${sharedDirectory}/bindings\"/>\n"
            + "            </server>\n"
            + "        </subsystem>"
            + "    </profile>\n"
            + "</server>";
    private static final String SUBSYTEM_EXPECTED_ACTIVEMQ = ""
            ...
            + "                <connection-factory name=\"InVmConnectionFactory\" connectors=\"in-vm\" entries=\"java:/ConnectionFactory\"/>\n"
            + "                <bindings-directory path=\"${sharedDirectory}/bindings\"/>\n"
            + "  <large-messages-directory path=\"${sharedDirectory}/large-messages\"/>"
            + "            </server>\n"
            + "        </subsystem>"
            + "    </profile>\n"
            + "</server>";
    private static final String SUBSYTEM_REPLACE_ACTIVEMQ = ""
            ...
            + "                <connection-factory name=\"InVmConnectionFactory\" connectors=\"in-vm\" entries=\"java:/ConnectionFactory\"/>\n"
            + "                <bindings-directory path=\"${sharedDirectory}/bindings\"/>\n"
            + "  <large-messages-directory path=\"REPLACED\"/>"
            + "            </server>\n"
            + "        </subsystem>"
            + "    </profile>\n"
            + "</server>";
    ...
    public void replace() throws Exception {
        ...
        client.apply(new SetLargeMessagesDirectory("REPLACED"));
    ...
    public void transform() throws Exception {
        ...
        client.apply(new SetLargeMessagesDirectory("${sharedDirectory}/large-messages"));
        System.out.println(Files.toString(cfg, Charsets.UTF_8));
        assertXmlIdentical(SUBSYTEM_EXPECTED_ACTIVEMQ, Files.toString(cfg, Charsets.UTF_8));
    }
    ...
    public void hornetq() throws Exception {
        ...
        client.apply(new SetLargeMessagesDirectory("${sharedDirectory}/journalREPLACED"));
