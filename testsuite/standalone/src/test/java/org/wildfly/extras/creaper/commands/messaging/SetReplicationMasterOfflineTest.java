 ...
 * @author mstyk
 */
public class SetReplicationMasterOfflineTest {
    ...
    private static final String SUBSYTEM_EXPECTED_ACTIVEMQ = ""
            ...
            + "                <jms-queue name=\"DLQ\" entries=\"java:/jms/queue/DLQ\"/>\n"
            + "                <connection-factory name=\"InVmConnectionFactory\" connectors=\"in-vm\" entries=\"java:/ConnectionFactory\"/>\n"
            + "<replication-master cluster-name=\"my-cluster\" group-name=\"firstPair\" check-for-live-server=\"true\"/>"
            + "            </server>\n"
            + "        </subsystem>"
            + "    </profile>\n"
            + "</server>";
    private static final String SUBSYTEM_REPLACE_ACTIVEMQ = ""
            ...
            + "                <jms-queue name=\"DLQ\" entries=\"java:/jms/queue/DLQ\"/>\n"
            + "                <connection-factory name=\"InVmConnectionFactory\" connectors=\"in-vm\" entries=\"java:/ConnectionFactory\"/>\n"
            + "<replication-master cluster-name=\"my-cluster\" group-name=\"secondPair\"/>"
            + "            </server>\n"
            + "        </subsystem>"
            + "    </profile>\n"
            + "</server>";
    ...
    public void replace() throws Exception {
        ...
        client.apply(new SetReplicationMaster.Builder()
                .clusterName("my-cluster")
                .groupName("secondPair")
                .build());
