 ...
 * @author mstyk
 */
public final class SetClusterPassword implements OfflineCommand, OnlineCommand {
     ...
     */
    public SetClusterPassword(String password) {
     ...
     */
    public SetClusterPassword(String password, String serverName) {
        if (password == null) {
    ...
    public void apply(OnlineCommandContext ctx) throws Exception {
        ...
        ops.writeAttribute(address, MessagingConstants.CLUSTER_PASSWORD, password);
    }
}
