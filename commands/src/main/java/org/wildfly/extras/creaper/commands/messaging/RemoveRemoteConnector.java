...
/**
 * Removes an existing remote connector.
 */
public final class RemoveRemoteConnector implements OnlineCommand, OfflineCommand {

    private final String name;
    private final String serverName;

    /**
     * Removes a connector from the default messaging server.
     */
    public RemoveRemoteConnector(String connectorName) {
        this(connectorName, MessagingUtils.DEFAULT_SERVER_NAME);
    }

    /**
     * Removes a connector from the specified messaging server. <b>NOT YET
     * IMPLEMENTED FOR OFFLINE!</b>
     */
    public RemoveRemoteConnector(String connectorName, String serverName) {
    ...
    public void apply(OnlineCommandContext ctx) throws IOException, CommandFailedException {
        ...
        ops.remove(MessagingUtils.address(ctx.client, serverName).and(MessagingConstants.REMOTE_CONNECTOR, name));
    }
    ...
    public void apply(OfflineCommandContext ctx) throws CommandFailedException {
        ...
        GroovyXmlTransform transform = GroovyXmlTransform.of(RemoveRemoteConnector.class)
    ...
    public String toString() {
        return "RemoveRemoteConnector " + name;
    }
}
