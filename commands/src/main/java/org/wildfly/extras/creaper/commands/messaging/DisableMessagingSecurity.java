...
/**
 * Disable security in messaging subsystem. Operation automatically replaces
 * previous value in default messaging subsystem
 *
 * @author mstyk
 */
public final class DisableMessagingSecurity implements OfflineCommand, OnlineCommand {
    ...
    public void apply(OnlineCommandContext ctx) throws Exception {
        ...
        ops.writeAttribute(address, MessagingConstants.SECURITY_ENABLED, false);
    }
}
